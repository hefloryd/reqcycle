...
public class CommonSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CommonPackage.CONTENT_ELEMENT: {
				ContentElement contentElement = (ContentElement)theEObject;
				T result = caseContentElement(contentElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommonPackage.REGEX: {
				Regex regex = (Regex)theEObject;
				T result = caseRegex(regex);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommonPackage.DOCUMENT_MODEL: {
				DocumentModel documentModel = (DocumentModel)theEObject;
				T result = caseDocumentModel(documentModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommonPackage.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommonPackage.STYLE: {
