...
public class PreferenceBasedTraceabilityDisabler implements ITraceabilityAnalyserDisabler {
	...
	public boolean isDisabled(Class<? extends IVisitor> visitorClass) {
		Map<String, Object> pref = manager.getSimpleConfiguration(null, Scope.WORKSPACE, AnalysersPreferencePage.PREF_ID, true);
		return pref != null && Boolean.FALSE.equals(pref.get(visitorClass.getName()));
	}
