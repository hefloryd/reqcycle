...
public class RequirementSourceDataActionBarContributor extends
	 ...
	 * @generated
	 */
	public RequirementSourceDataActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("requirementsourcedata-settings"));
		toolBarManager.add(new Separator("requirementsourcedata-additions"));
	}
	...
	protected Collection<IAction> generateCreateChildActions(
		...
		if (descriptors != null) {
			for (Object descriptor : descriptors) {
				...
				// && ((CommandParameter) descriptor).getValue() instanceof
				// Requirement) {
				...
				// Command createCommand = super.createActionCommand(
				// editingDomain, collection);
				// Collection<Scope> scopes = getScope(collection);
				// CustomSetCommand addCommand = new CustomSetCommand(
				// editingDomain,
				// createCommand.getResult(),
				// RequirementSourceDataPackage.Literals.ABSTRACT_ELEMENT__SCOPES,
				// scopes);
				// CompoundCommand cc = new CompoundCommand(Arrays
				// .asList(createCommand, addCommand));
				// return cc;
				// }
				//
				// private Collection<Scope> getScope(
				// Collection<?> collection) {
