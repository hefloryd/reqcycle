/**
 */
package org.polarsys.kitalpha.doc.doc2model.common.Common.provider;
...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.doc.doc2model.common.Common.ContentElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContentElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContentElement_textContent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContentElement_textContent_feature", "_UI_ContentElement_type"),
				 CommonPackage.Literals.CONTENT_ELEMENT__TEXT_CONTENT,
				 true,
				 false,
				 false,
	...
	protected void addStyleNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContentElement_styleName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContentElement_styleName_feature", "_UI_ContentElement_type"),
				 CommonPackage.Literals.CONTENT_ELEMENT__STYLE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CommonPackage.Literals.CONTENT_ELEMENT__STYLE);
		}
	...
	public String getText(Object object) {
		String label = ((ContentElement)object).getTextContent();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CommonPackage.Literals.CONTENT_ELEMENT__STYLE,
				 CommonFactory.eINSTANCE.createStyle()));
	}
