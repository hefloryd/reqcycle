...
public class DecorationPredicateImpl extends IPredicateLinkImpl implements DecorationPredicate {
	...
	public void setStyle(String newStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeconfigurationPackage.DECORATION_PREDICATE__STYLE, oldStyle, style));
	}
	...
	public void setColor(String newColor) {
		...
		color = newColor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeconfigurationPackage.DECORATION_PREDICATE__COLOR, oldColor, color));
	}
