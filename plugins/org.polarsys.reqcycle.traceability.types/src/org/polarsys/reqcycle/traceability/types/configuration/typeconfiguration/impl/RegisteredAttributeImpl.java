...
public class RegisteredAttributeImpl extends StdAttributeImpl implements
	...
	protected EClass eStaticClass() {
		return TypeconfigurationPackage.Literals.REGISTERED_ATTRIBUTE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeconfigurationPackage.REGISTERED_ATTRIBUTE__ID, oldId, id));
	}
