...
public class TraceabilityAttributesManager implements ITraceabilityAttributesManager {
	...
	public Collection<EditableAttribute> getAttributes(Reachable reachable) {
		...
		Configuration defaultConfiguration = typesConfigurationProvider.getDefaultConfiguration();
	...
	private Collection<EditableAttribute> getAttributes(Reachable reachable, Configuration configuration, ITraceabilityStorage storage) {
		final String relationName = storage.getProperty(reachable, RELATION_NAME);
		if (relationName != null) {
			Relation rel = find(configuration.getRelations(), new Predicate<Relation>() {
	...
	private Collection<EditableAttribute> getAttributes(Reachable reachable, Relation rel) {
