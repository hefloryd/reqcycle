...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Type Config Container</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface TypeConfigContainer extends EObject {
	/**
	 * Returns the value of the '<em><b>Types</b></em>' containment reference list. The list contents are of type {@link org.polarsys.reqcycle.traceability.types.configuration.typeconfiguration.Type}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Configurations</b></em>' containment reference list. The list contents are of type {@link org.polarsys.reqcycle.traceability.types.configuration.typeconfiguration.Configuration}. It is bidirectional and its
	 * opposite is '{@link org.polarsys.reqcycle.traceability.types.configuration.typeconfiguration.Configuration#getParent <em>Parent</em>}'. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Default Configuration</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Default Configuration</em>' reference isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.polarsys.reqcycle.traceability.types.configuration.typeconfiguration.TypeConfigContainer#getDefaultConfiguration <em>Default Configuration</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Default Configuration</em>' reference.
	...
	/**
	 * Returns the value of the '<em><b>Mappings</b></em>' containment reference list. The list contents are of type {@link org.polarsys.reqcycle.traceability.types.configuration.typeconfiguration.RelationsPredicatesMapping}. <!-- begin-user-doc -->
	 * <p>
