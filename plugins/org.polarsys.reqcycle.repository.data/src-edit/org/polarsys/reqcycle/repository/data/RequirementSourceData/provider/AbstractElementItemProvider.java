...
public class AbstractElementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_AbstractElement_id_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_AbstractElement_id_feature", "_UI_AbstractElement_type"), RequirementSourceDataPackage.Literals.ABSTRACT_ELEMENT__ID, true, false, false,
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_AbstractElement_text_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_AbstractElement_text_feature", "_UI_AbstractElement_type"), RequirementSourceDataPackage.Literals.ABSTRACT_ELEMENT__TEXT, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addUriPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_AbstractElement_uri_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_AbstractElement_uri_feature", "_UI_AbstractElement_type"), RequirementSourceDataPackage.Literals.ABSTRACT_ELEMENT__URI, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Scopes feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addScopesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_AbstractElement_scopes_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_AbstractElement_scopes_feature", "_UI_AbstractElement_type"), RequirementSourceDataPackage.Literals.ABSTRACT_ELEMENT__SCOPES, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_AbstractElement_type") : getString("_UI_AbstractElement_type") + " " + label;
	}
