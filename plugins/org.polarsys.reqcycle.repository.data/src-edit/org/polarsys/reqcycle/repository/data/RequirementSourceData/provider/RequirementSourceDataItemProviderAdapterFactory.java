...
public class RequirementSourceDataItemProviderAdapterFactory extends RequirementSourceDataAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.polarsys.reqcycle.repository.data.RequirementSourceData.Section} instances. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.polarsys.reqcycle.repository.data.RequirementSourceData.SimpleRequirement} instances. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.polarsys.reqcycle.repository.data.RequirementSourceData.Requirement} instances. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.polarsys.reqcycle.repository.data.RequirementSourceData.RequirementsContainer} instances. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public void dispose() {
		...
		if (simpleRequirementItemProvider != null)
			simpleRequirementItemProvider.dispose();
		if (requirementItemProvider != null)
			requirementItemProvider.dispose();
		if (requirementsContainerItemProvider != null)
			requirementsContainerItemProvider.dispose();
	}
