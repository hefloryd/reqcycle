...
/**
 * This is the item provider adapter for a {@link org.polarsys.reqcycle.repository.data.ScopeConf.Scope} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addDataModelURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scope_DataModelURI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scope_DataModelURI_feature", "_UI_Scope_type"),
				 ScopeConfPackage.Literals.SCOPE__DATA_MODEL_URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
