 ...
 */
package org.polarsys.reqcycle.repository.data.ScopeConf.provider;
...
/**
 * This is the item provider adapter for a {@link org.polarsys.reqcycle.repository.data.ScopeConf.Scope} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ScopeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	...
	/**
	 * This adds a property descriptor for the Requirements feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This adds a property descriptor for the Data Model Name feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addDataModelNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Scope_dataModelName_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Scope_dataModelName_feature", "_UI_Scope_type"), ScopeConfPackage.Literals.SCOPE__DATA_MODEL_NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
