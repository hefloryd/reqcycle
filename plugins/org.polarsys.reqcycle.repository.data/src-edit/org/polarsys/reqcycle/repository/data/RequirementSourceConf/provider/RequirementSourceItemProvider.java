...
/**
 * This is the item provider adapter for a {@link org.polarsys.reqcycle.repository.data.RequirementSourceConf.RequirementSource} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class RequirementSourceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDestinationURIPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Connector Id feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This adds a property descriptor for the Data Model URI feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This adds a property descriptor for the Default Scope feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This adds a property descriptor for the Repository URI feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addRepositoryURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_RequirementSource_repositoryURI_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_RequirementSource_repositoryURI_feature", "_UI_RequirementSource_type"), RequirementSourceConfPackage.Literals.REQUIREMENT_SOURCE__REPOSITORY_URI, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Destination URI feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addDestinationURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_RequirementSource_destinationURI_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_RequirementSource_destinationURI_feature", "_UI_RequirementSource_type"), RequirementSourceConfPackage.Literals.REQUIREMENT_SOURCE__DESTINATION_URI, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	/**
	 * This returns RequirementSource.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
