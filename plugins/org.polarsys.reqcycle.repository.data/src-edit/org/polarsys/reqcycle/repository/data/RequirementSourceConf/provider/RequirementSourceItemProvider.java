...
public class RequirementSourceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void addRepositoryURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequirementSource_repositoryURI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequirementSource_repositoryURI_feature", "_UI_RequirementSource_type"),
				 RequirementSourceConfPackage.Literals.REQUIREMENT_SOURCE__REPOSITORY_URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Destination URI feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDestinationURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequirementSource_destinationURI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequirementSource_destinationURI_feature", "_UI_RequirementSource_type"),
				 RequirementSourceConfPackage.Literals.REQUIREMENT_SOURCE__DESTINATION_URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
