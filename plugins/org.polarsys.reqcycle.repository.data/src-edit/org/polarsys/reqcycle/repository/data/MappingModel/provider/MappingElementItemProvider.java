...
/**
 * This is the item provider adapter for a {@link org.polarsys.reqcycle.repository.data.MappingModel.MappingElement} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MappingElementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_MappingElement_description_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_MappingElement_description_feature", "_UI_MappingElement_type"), MappingModelPackage.Literals.MAPPING_ELEMENT__DESCRIPTION, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Target Element feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addTargetElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_MappingElement_targetElement_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_MappingElement_targetElement_feature", "_UI_MappingElement_type"), MappingModelPackage.Literals.MAPPING_ELEMENT__TARGET_ELEMENT, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Source Qualifier feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addSourceQualifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_MappingElement_sourceQualifier_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_MappingElement_sourceQualifier_feature", "_UI_MappingElement_type"), MappingModelPackage.Literals.MAPPING_ELEMENT__SOURCE_QUALIFIER, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	/**
	 * This returns MappingElement.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_MappingElement_type") : getString("_UI_MappingElement_type") + " " + label;
	}
