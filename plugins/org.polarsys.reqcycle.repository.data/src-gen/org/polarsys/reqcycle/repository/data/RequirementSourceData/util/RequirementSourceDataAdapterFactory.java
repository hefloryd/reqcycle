...
public class RequirementSourceDataAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * <em>Abstract Element</em>}'. <!-- begin-user-doc --> This default
	 ...
	 * <em>Simple Requirement</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Requirements Container</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
