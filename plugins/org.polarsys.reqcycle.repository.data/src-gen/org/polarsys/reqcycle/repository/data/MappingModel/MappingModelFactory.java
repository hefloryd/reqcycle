...
public interface MappingModelFactory extends EFactory {
	 ...
	 * @generated
	 */
	MappingModelFactory eINSTANCE = org.polarsys.reqcycle.repository.data.MappingModel.impl.MappingModelFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Mapping Element</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Mapping Attribute</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
