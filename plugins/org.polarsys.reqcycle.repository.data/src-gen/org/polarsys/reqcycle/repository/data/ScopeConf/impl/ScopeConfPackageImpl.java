...
public class ScopeConfPackageImpl extends EPackageImpl implements ScopeConfPackage {
	 ...
	 * @see org.polarsys.reqcycle.repository.data.ScopeConf.ScopeConfPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link ScopeConfPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the package. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #eNS_URI
