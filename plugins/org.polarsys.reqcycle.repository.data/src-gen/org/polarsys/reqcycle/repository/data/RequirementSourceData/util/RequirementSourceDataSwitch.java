...
public class RequirementSourceDataSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RequirementSourceDataPackage.TRASH: {
				Trash trash = (Trash)theEObject;
				T result = caseTrash(trash);
				if (result == null) result = caseSection(trash);
				if (result == null) result = caseAbstractElement(trash);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Simple Requirement</em>'.
	 * <!-- begin-user-doc --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * @param object the target of the switch.
