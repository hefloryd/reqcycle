...
public interface RequirementSourceConfPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Repository URI</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int REQUIREMENT_SOURCE__REPOSITORY_URI = 7;

	/**
	 * The feature id for the '<em><b>Destination URI</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int REQUIREMENT_SOURCE__DESTINATION_URI = 8;
	 ...
	 * @ordered
	 */
	int REQUIREMENT_SOURCE_FEATURE_COUNT = 9;
	...
	/**
	 * Returns the meta object for the attribute '{@link org.polarsys.reqcycle.repository.data.RequirementSourceConf.RequirementSource#getRepositoryURI <em>Repository URI</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Repository URI</em>'.
	 * @see org.polarsys.reqcycle.repository.data.RequirementSourceConf.RequirementSource#getRepositoryURI()
	 * @see #getRequirementSource()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link org.polarsys.reqcycle.repository.data.RequirementSourceConf.RequirementSource#getDestinationURI <em>Destination URI</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Destination URI</em>'.
	 * @see org.polarsys.reqcycle.repository.data.RequirementSourceConf.RequirementSource#getDestinationURI()
	 * @see #getRequirementSource()
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Repository URI</b></em>' attribute feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute REQUIREMENT_SOURCE__REPOSITORY_URI = eINSTANCE.getRequirementSource_RepositoryURI();

		/**
		 * The meta object literal for the '<em><b>Destination URI</b></em>' attribute feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute REQUIREMENT_SOURCE__DESTINATION_URI = eINSTANCE.getRequirementSource_DestinationURI();
