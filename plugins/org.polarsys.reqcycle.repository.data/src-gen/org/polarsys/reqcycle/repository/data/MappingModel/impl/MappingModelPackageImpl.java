...
public class MappingModelPackageImpl extends EPackageImpl implements MappingModelPackage {
	 ...
	 * @see org.polarsys.reqcycle.repository.data.MappingModel.MappingModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link MappingModelPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the package. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #eNS_URI
	...
	public void initializePackageContents() {
		...
		initEReference(getMappingElement_TargetElement(), theEcorePackage.getEClass(), null, "targetElement", null, 1, 1, MappingElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getMappingElement_Attributes(), this.getMappingAttribute(), null, "attributes", null, 0, -1, MappingElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMappingAttribute_TargetAttribute(), theEcorePackage.getEAttribute(), null, "targetAttribute", null, 1, 1, MappingAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
