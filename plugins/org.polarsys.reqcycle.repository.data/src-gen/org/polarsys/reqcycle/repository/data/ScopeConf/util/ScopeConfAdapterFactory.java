...
public class ScopeConfAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.polarsys.reqcycle.repository.data.ScopeConf.Scopes <em>Scopes</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.polarsys.reqcycle.repository.data.ScopeConf.Scope <em>Scope</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
