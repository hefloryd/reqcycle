...
public class RequirementSourceConfAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.repository.data.RequirementSourceConf.RequirementSources <em>Requirement Sources</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.repository.data.RequirementSourceConf.RequirementSource <em>Requirement Source</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
