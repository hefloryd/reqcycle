...
public class ImpactFactoryImpl extends EFactoryImpl implements ImpactFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ImpactPackage.IMPACT_ANALYSIS: return createImpactAnalysis();
			case ImpactPackage.REQUIREMENT_IMPACTED: return createRequirementImpacted();
			case ImpactPackage.TRACEABILITY_LINK: return createTraceabilityLink();
			case ImpactPackage.ATTRIBUTE_IMPACTED: return createAttributeImpacted();
			default:
