...
public class ImpactAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ImpactSwitch<Adapter> modelSwitch = new ImpactSwitch<Adapter>() {
		@Override
		public Adapter caseImpactAnalysis(ImpactAnalysis object) {
			return createImpactAnalysisAdapter();
		}

		@Override
		public Adapter caseRequirementImpacted(RequirementImpacted object) {
			return createRequirementImpactedAdapter();
		}
		...
		@Override
		public Adapter caseAttributeImpacted(AttributeImpacted object) {
			return createAttributeImpactedAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.impact.Impact.ImpactAnalysis <em>Analysis</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.impact.Impact.RequirementImpacted <em>Requirement Impacted</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.impact.Impact.TraceabilityLink <em>Traceability Link</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.impact.Impact.AttributeImpacted <em>Attribute Impacted</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
