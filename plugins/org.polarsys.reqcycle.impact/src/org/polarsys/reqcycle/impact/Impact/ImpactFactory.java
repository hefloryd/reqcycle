...
public interface ImpactFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Analysis</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Requirement Impacted</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Traceability Link</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Attribute Impacted</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
