...
public class AttributeImpactedImpl extends MinimalEObjectImpl.Container implements AttributeImpacted {
	...
	protected EClass eStaticClass() {
		return ImpactPackage.Literals.ATTRIBUTE_IMPACTED;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImpactPackage.ATTRIBUTE_IMPACTED__ID, oldId, id));
	}
	...
	public void setOldValue(String newOldValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImpactPackage.ATTRIBUTE_IMPACTED__OLD_VALUE, oldOldValue, oldValue));
	}
	...
	public void setNewValue(String newNewValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImpactPackage.ATTRIBUTE_IMPACTED__NEW_VALUE, oldNewValue, newValue));
	}
