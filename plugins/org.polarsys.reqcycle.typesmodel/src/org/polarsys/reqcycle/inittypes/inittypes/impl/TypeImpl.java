 ...
 * <ul>
 *   <li>{@link org.polarsys.reqcycle.inittypes.inittypes.impl.TypeImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link org.polarsys.reqcycle.inittypes.inittypes.impl.TypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeImpl extends MinimalEObjectImpl.Container implements Type {
	...
	public EList<Requirement> getRequirements() {
		if (requirements == null) {
			requirements = new EObjectContainmentEList<Requirement>(Requirement.class, this, InittypesPackage.TYPE__REQUIREMENTS);
		}
		return requirements;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InittypesPackage.TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InittypesPackage.TYPE__REQUIREMENTS:
