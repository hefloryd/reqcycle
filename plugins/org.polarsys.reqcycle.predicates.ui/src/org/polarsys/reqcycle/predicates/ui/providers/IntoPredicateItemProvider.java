...
/**
 * This is the item provider adapter for a {@link org.polarsys.reqcycle.predicates.core.api.IntoPredicate} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class IntoPredicateItemProvider extends PredicatesItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemColorProvider,
		IItemFontProvider {
	/**
	...
	protected void addInputPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_IntoPredicate_input_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_IntoPredicate_input_feature", "_UI_IntoPredicate_type"), PredicatesPackage.Literals.INTO_PREDICATE__INPUT, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}

	/**
	 * This adds a property descriptor for the Allowed Entries feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addAllowedEntriesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_IntoPredicate_allowedEntries_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_IntoPredicate_allowedEntries_feature", "_UI_IntoPredicate_type"), PredicatesPackage.Literals.INTO_PREDICATE__ALLOWED_ENTRIES, true, false, false,
