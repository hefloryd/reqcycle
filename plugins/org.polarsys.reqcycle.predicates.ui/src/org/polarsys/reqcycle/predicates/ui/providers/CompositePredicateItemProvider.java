...
/**
 * This is the item provider adapter for a {@link org.polarsys.reqcycle.predicates.core.api.CompositePredicate} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class CompositePredicateItemProvider extends PredicatesItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemColorProvider,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(PredicatesPackage.Literals.COMPOSITE_PREDICATE__PREDICATES, PredicatesFactory.eINSTANCE.createIEAttrPredicate()));

		newChildDescriptors.add(createChildParameter(PredicatesPackage.Literals.COMPOSITE_PREDICATE__PREDICATES, PredicatesFactory.eINSTANCE.createTruePredicate()));

		newChildDescriptors.add(createChildParameter(PredicatesPackage.Literals.COMPOSITE_PREDICATE__PREDICATES, PredicatesFactory.eINSTANCE.createOperationPredicate()));

		newChildDescriptors.add(createChildParameter(PredicatesPackage.Literals.COMPOSITE_PREDICATE__PREDICATES, PredicatesFactory.eINSTANCE.createIsTypeOfPredicate()));

		newChildDescriptors.add(createChildParameter(PredicatesPackage.Literals.COMPOSITE_PREDICATE__PREDICATES, PredicatesFactory.eINSTANCE.createIsNullPredicate()));
	}
