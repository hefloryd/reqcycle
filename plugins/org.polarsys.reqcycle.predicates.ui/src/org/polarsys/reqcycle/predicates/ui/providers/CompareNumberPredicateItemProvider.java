...
/**
 * This is the item provider adapter for a {@link org.polarsys.reqcycle.predicates.core.api.CompareNumberPredicate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompareNumberPredicateItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_CompareNumberPredicate_input_feature", "_UI_CompareNumberPredicate_type"),
				 PredicatesPackage.Literals.COMPARE_NUMBER_PREDICATE__INPUT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addExpectedValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompareNumberPredicate_expectedValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompareNumberPredicate_expectedValue_feature", "_UI_CompareNumberPredicate_type"),
				 PredicatesPackage.Literals.COMPARE_NUMBER_PREDICATE__EXPECTED_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOperatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompareNumberPredicate_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompareNumberPredicate_operator_feature", "_UI_CompareNumberPredicate_type"),
				 PredicatesPackage.Literals.COMPARE_NUMBER_PREDICATE__OPERATOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_CompareNumberPredicate_type") :
			getString("_UI_CompareNumberPredicate_type") + " " + label;
	}
