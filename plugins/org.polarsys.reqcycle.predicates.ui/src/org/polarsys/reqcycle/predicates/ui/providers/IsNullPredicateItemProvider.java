...
/**
 * This is the item provider adapter for a {@link org.polarsys.reqcycle.predicates.core.api.IsNullPredicate} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class IsNullPredicateItemProvider extends PredicatesItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemColorProvider,
	...
	/**
	 * This returns IsNullPredicate.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_IsNullPredicate_type") : getString("_UI_IsNullPredicate_type") + " " + label;
	}
