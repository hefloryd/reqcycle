...
/**
 * This is the action bar contributor for the Predicates model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PredicatesActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("predicates-settings"));
		toolBarManager.add(new Separator("predicates-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PredicatesUIPlugin.INSTANCE.getString("_UI_PredicatesEditor_menu"), "org.polarsys.reqcycle.predicates.core.apiMenuID");
		...
		//
		createChildMenuManager = new MenuManager(PredicatesUIPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(PredicatesUIPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
