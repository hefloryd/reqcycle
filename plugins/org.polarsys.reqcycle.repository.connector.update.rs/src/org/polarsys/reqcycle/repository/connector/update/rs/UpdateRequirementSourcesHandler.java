...
public class UpdateRequirementSourcesHandler {
	...
	/**
	 * @param oldSource : the source in a configuration
	 * @param updateSource : the new generated source updated
	 */
	...
	public void setInputRequirementSources(
			Map<RequirementSource, String> requirementSources) {
		this.InputrequirementSources = requirementSources;
	}
