...
public class BooleanParameterImpl extends ParameterImpl implements BooleanParameter {
	...
	protected EClass eStaticClass() {
		return StylingPackage.Literals.BOOLEAN_PARAMETER;
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StylingPackage.BOOLEAN_PARAMETER__VALUE, oldValue, value));
	}
