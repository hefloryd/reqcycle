...
public interface StylingFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Icon</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Constant Pattern</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Model Pattern</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Operation Pattern</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
