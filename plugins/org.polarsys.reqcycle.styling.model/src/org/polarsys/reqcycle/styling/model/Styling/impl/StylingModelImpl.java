...
public class StylingModelImpl extends MinimalEObjectImpl.Container implements StylingModel {
	...
	/**
	 * The cached value of the '{@link #getStyles() <em>Styles</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getStyles()
	 * @generated
	 * @ordered
	...
	/**
	 * The default value of the '{@link #getModeName() <em>Mode Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getModeName()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getModeName() <em>Mode Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getModeName()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getDefault() <em>Default</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getDefault()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getBasic() <em>Basic</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getBasic()
	 * @generated
	 * @ordered
