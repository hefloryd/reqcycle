...
public class ConstantPatternImpl extends PatternImpl implements ConstantPattern {
	...
	protected EClass eStaticClass() {
		return StylingPackage.Literals.CONSTANT_PATTERN;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StylingPackage.CONSTANT_PATTERN__VALUE, oldValue, value));
	}
