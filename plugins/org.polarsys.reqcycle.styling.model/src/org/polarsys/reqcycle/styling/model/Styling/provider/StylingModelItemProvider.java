...
/**
 * This is the item provider adapter for a {@link org.polarsys.reqcycle.styling.model.Styling.StylingModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StylingModelItemProvider 
	...
	/**
	 * This adds a property descriptor for the Mode Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StylingModel_modeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StylingModel_modeName_feature", "_UI_StylingModel_type"),
				 StylingPackage.Literals.STYLING_MODEL__MODE_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_StylingModel_type") :
			getString("_UI_StylingModel_type") + " " + label;
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(StylingPackage.Literals.STYLING_MODEL__STYLES,
				 StylingFactory.eINSTANCE.createStylingPredicate()));
