...
public class StylingPackageImpl extends EPackageImpl implements StylingPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link StylingPackage#eINSTANCE} when that field is accessed.
	...
	public static StylingPackage init() {
		if (isInited) return (StylingPackage)EPackage.Registry.INSTANCE.getEPackage(StylingPackage.eNS_URI);
	...
	public void initializePackageContents() {
		...
		initEReference(getOperationPattern_Parameters(), this.getParameter(), null, "parameters", null, 0, -1, OperationPattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
