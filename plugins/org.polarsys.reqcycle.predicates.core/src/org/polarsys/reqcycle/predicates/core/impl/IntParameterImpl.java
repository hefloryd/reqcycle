...
public class IntParameterImpl extends ParameterImpl implements IntParameter {
	...
	protected EClass eStaticClass() {
		return PredicatesPackage.Literals.INT_PARAMETER;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PredicatesPackage.INT_PARAMETER__VALUE, oldValue, value));
	}
