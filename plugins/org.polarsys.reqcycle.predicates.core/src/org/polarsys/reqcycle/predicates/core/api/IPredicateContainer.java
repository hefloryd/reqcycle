...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>IPredicate Container</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface IPredicateContainer extends IPredicate {
	/**
	 * Returns the value of the '<em><b>Result Predicate</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Result Predicate</em>' containment reference isn't clear,
	...
	/**
	 * Sets the value of the '{@link org.polarsys.reqcycle.predicates.core.api.IPredicateContainer#getResultPredicate <em>Result Predicate</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Result Predicate</em>' containment reference.
