...
public class PredicatesSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		...
		case PredicatesPackage.CUSTOM_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(customPredicate);
			if(result == null)
				result = caseITypedPredicate(customPredicate);
			if(result == null)
		...
		case PredicatesPackage.EQUAL_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(equalPredicate);
			if(result == null)
				result = caseITypedPredicate(equalPredicate);
			if(result == null)
		...
		case PredicatesPackage.STRING_EQUAL_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(stringEqualPredicate);
			if(result == null)
				result = caseITypedPredicate(stringEqualPredicate);
			if(result == null)
		...
		case PredicatesPackage.DATE_EQUAL_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(dateEqualPredicate);
			if(result == null)
				result = caseITypedPredicate(dateEqualPredicate);
			if(result == null)
		...
		case PredicatesPackage.ENUM_EQUAL_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(enumEqualPredicate);
			if(result == null)
				result = caseITypedPredicate(enumEqualPredicate);
			if(result == null)
		...
		case PredicatesPackage.BOOLEAN_EQUAL_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(booleanEqualPredicate);
			if(result == null)
				result = caseITypedPredicate(booleanEqualPredicate);
			if(result == null)
		...
		case PredicatesPackage.CONTAINS_PATTERN_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(containsPatternPredicate);
			if(result == null)
				result = caseITypedPredicate(containsPatternPredicate);
			if(result == null)
		...
		case PredicatesPackage.INTO_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(intoPredicate);
			if(result == null)
				result = caseITypedPredicate(intoPredicate);
			if(result == null)
		...
		case PredicatesPackage.STRING_INTO_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(stringIntoPredicate);
			if(result == null)
				result = caseITypedPredicate(stringIntoPredicate);
			if(result == null)
		...
		case PredicatesPackage.ENUM_INTO_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(enumIntoPredicate);
			if(result == null)
				result = caseITypedPredicate(enumIntoPredicate);
			if(result == null)
		...
		case PredicatesPackage.COMPARE_NUMBER_PREDICATE:
		{
			...
			if(result == null)
				result = caseIEAttrPredicate(compareNumberPredicate);
			if(result == null)
				result = caseITypedPredicate(compareNumberPredicate);
			if(result == null)
