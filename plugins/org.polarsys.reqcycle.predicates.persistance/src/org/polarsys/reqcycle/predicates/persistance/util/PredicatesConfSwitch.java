...
public class PredicatesConfSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PredicatesConfPackage.PREDICATES_CONF: {
			PredicatesConf predicatesConf = (PredicatesConf) theEObject;
			T result = casePredicatesConf(predicatesConf);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Predicates Conf</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Predicates Conf</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePredicatesConf(PredicatesConf object) {
		return null;
	}
