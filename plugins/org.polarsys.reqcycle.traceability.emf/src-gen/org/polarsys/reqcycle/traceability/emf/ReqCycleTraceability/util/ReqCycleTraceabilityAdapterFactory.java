...
public class ReqCycleTraceabilityAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.polarsys.reqcycle.traceability.emf.ReqCycleTraceability.EReachable <em>EReachable</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.polarsys.reqcycle.traceability.emf.ReqCycleTraceability.ELink <em>ELink</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.polarsys.reqcycle.traceability.emf.ReqCycleTraceability.Element <em>Element</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.polarsys.reqcycle.traceability.emf.ReqCycleTraceability.Property <em>Property</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
