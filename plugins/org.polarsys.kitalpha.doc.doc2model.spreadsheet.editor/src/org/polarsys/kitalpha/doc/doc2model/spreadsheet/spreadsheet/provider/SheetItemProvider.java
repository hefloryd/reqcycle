...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.doc.doc2model.spreadsheet.spreadsheet.Sheet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SheetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SpreadsheetPackage.Literals.SHEET__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpreadsheetPackage.Literals.SHEET__TEXT);
			childrenFeatures.add(SpreadsheetPackage.Literals.SHEET__IMAGE);
			childrenFeatures.add(SpreadsheetPackage.Literals.SHEET__TABLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpreadsheetPackage.Literals.SHEET__TEXT,
				 SpreadsheetFactory.eINSTANCE.createText()));

		newChildDescriptors.add
			(createChildParameter
				(SpreadsheetPackage.Literals.SHEET__IMAGE,
				 SpreadsheetFactory.eINSTANCE.createImage()));

		newChildDescriptors.add
			(createChildParameter
				(SpreadsheetPackage.Literals.SHEET__TABLE,
				 SpreadsheetFactory.eINSTANCE.createTable()));
	}
