...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.doc.doc2model.spreadsheet.spreadsheet.Text} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_title_feature", "_UI_Text_type"),
				 SpreadsheetPackage.Literals.TEXT__TITLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTextContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_textContent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_textContent_feature", "_UI_Text_type"),
				 SpreadsheetPackage.Literals.TEXT__TEXT_CONTENT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Text)object).getTextContent();
