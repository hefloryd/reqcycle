...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.doc.doc2model.spreadsheet.spreadsheet.Title} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TitleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Title_hiearchy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Title_hiearchy_feature", "_UI_Title_type"),
				 SpreadsheetPackage.Literals.TITLE__HIEARCHY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Title)object).getStyleName();
		return label == null || label.length() == 0 ?
			getString("_UI_Title_type") :
