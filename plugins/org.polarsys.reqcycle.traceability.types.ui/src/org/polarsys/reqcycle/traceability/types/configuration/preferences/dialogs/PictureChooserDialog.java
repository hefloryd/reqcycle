...
import org.polarsys.reqcycle.traceability.types.configuration.preferences.dialogs.IconRegistry.Descriptor;
...
public class PictureChooserDialog extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public PictureChooserDialog(Shell parentShell) {
		super(parentShell);
	}
