...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Excel File</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.polarsys.kitalpha.doc.doc2model.spreadsheet.spreadsheet.impl.ExcelFileImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.polarsys.kitalpha.doc.doc2model.spreadsheet.spreadsheet.impl.ExcelFileImpl#getSheet <em>Sheet</em>}</li>
 *   <li>{@link org.polarsys.kitalpha.doc.doc2model.spreadsheet.spreadsheet.impl.ExcelFileImpl#getNbSheet <em>Nb Sheet</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ExcelFileImpl extends MinimalEObjectImpl.Container implements ExcelFile {
	/**
	...
	protected EClass eStaticClass() {
		return SpreadsheetPackage.Literals.EXCEL_FILE;
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, SpreadsheetPackage.EXCEL_FILE__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public EList<Sheet> getSheet() {
		if (sheet == null) {
			sheet = new EObjectContainmentEList<Sheet>(Sheet.class, this, SpreadsheetPackage.EXCEL_FILE__SHEET);
		}
		return sheet;
	}
	...
	public void setNbSheet(int newNbSheet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpreadsheetPackage.EXCEL_FILE__NB_SHEET, oldNbSheet, nbSheet));
	}
