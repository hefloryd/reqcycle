...
public class CacheTracabilityPackageImpl extends EPackageImpl implements CacheTracabilityPackage {
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link CacheTracabilityPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the package. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #eNS_URI
	...
	public static CacheTracabilityPackage init() {
		...
		CacheTracabilityPackageImpl theCacheTracabilityPackage = (CacheTracabilityPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CacheTracabilityPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
				: new CacheTracabilityPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getTraceabilityLink_Attributes(), this.getAttribute(), null, "attributes", null, 0, -1, TraceabilityLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getTraceabilityLink_Sources(), this.getTraceableElement(), this.getTraceableElement_Outgoings(), "sources", null, 0, -1, TraceabilityLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTraceabilityLink_Targets(), this.getTraceableElement(), this.getTraceableElement_Incomings(), "targets", null, 0, -1, TraceabilityLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTraceabilityLink_Resource(), this.getAnalyzedResource(), this.getAnalyzedResource_Links(), "resource", null, 0, 1, TraceabilityLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTraceableElement_Outgoings(), this.getTraceabilityLink(), this.getTraceabilityLink_Sources(), "outgoings", null, 0, -1, TraceableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTraceableElement_Incomings(), this.getTraceabilityLink(), this.getTraceabilityLink_Targets(), "incomings", null, 0, -1, TraceableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTraceableElement_Properties(), this.getProperty(), null, "properties", null, 0, -1, TraceableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAnalyzedResource_Contained(), this.getTraceabilityLink(), null, "contained", null, 0, 1, AnalyzedResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getAnalyzedResource_Links(), this.getTraceabilityLink(), this.getTraceabilityLink_Resource(), "links", null, 0, -1, AnalyzedResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
