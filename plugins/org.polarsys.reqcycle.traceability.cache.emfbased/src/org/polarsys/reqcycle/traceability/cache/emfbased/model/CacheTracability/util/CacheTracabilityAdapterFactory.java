...
public class CacheTracabilityAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected CacheTracabilitySwitch<Adapter> modelSwitch = new CacheTracabilitySwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.traceability.cache.emfbased.model.CacheTracability.TraceabilityLink <em>Traceability Link</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.traceability.cache.emfbased.model.CacheTracability.Attribute <em>Attribute</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.traceability.cache.emfbased.model.CacheTracability.TraceableElement <em>Traceable Element</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	 * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.traceability.cache.emfbased.model.CacheTracability.Model <em>Model</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.traceability.cache.emfbased.model.CacheTracability.AnalyzedResource <em>Analyzed Resource</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	 * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.traceability.cache.emfbased.model.CacheTracability.URIElement <em>URI Element</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.reqcycle.traceability.cache.emfbased.model.CacheTracability.Property <em>Property</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
