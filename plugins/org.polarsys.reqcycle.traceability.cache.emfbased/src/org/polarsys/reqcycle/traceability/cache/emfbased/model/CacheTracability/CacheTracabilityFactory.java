...
public interface CacheTracabilityFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Traceable Element</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Analyzed Resource</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
