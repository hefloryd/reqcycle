...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>URI Element</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface URIElement extends EObject {
	...
	/**
	 * Sets the value of the '{@link org.polarsys.reqcycle.traceability.cache.emfbased.model.CacheTracability.URIElement#getUri <em>Uri</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
