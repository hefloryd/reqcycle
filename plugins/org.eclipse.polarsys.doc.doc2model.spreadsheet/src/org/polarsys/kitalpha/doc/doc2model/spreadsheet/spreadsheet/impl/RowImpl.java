 ...
 * <ul>
 *   <li>{@link org.polarsys.kitalpha.doc.doc2model.spreadsheet.spreadsheet.impl.RowImpl#getCell <em>Cell</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RowImpl extends MinimalEObjectImpl.Container implements Row {
	...
	public EList<Cell> getCell() {
		if (cell == null) {
			cell = new EObjectContainmentEList<Cell>(Cell.class, this, SpreadsheetPackage.ROW__CELL);
		}
		return cell;
	}
