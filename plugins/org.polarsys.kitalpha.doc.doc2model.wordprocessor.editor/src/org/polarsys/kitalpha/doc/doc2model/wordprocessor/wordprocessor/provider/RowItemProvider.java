...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.doc.doc2model.wordprocessor.wordprocessor.Row} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RowItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Row_cell_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Row_cell_feature", "_UI_Row_type"),
				 WordprocessorPackage.Literals.ROW__CELL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WordprocessorPackage.Literals.ROW__CELL);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Row.class)) {
			case WordprocessorPackage.ROW__CELL:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WordprocessorPackage.Literals.ROW__CELL,
				 WordprocessorFactory.eINSTANCE.createCell()));
	}
