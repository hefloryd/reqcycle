...
/**
 * This is the item provider adapter for a {@link org.polarsys.kitalpha.doc.doc2model.wordprocessor.wordprocessor.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_row_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_row_feature", "_UI_Table_type"),
				 WordprocessorPackage.Literals.TABLE__ROW,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WordprocessorPackage.Literals.SECTION_CONTENTS__SUBTITLE);
			childrenFeatures.add(WordprocessorPackage.Literals.TABLE__TITLE);
			childrenFeatures.add(WordprocessorPackage.Literals.TABLE__HEADER);
			childrenFeatures.add(WordprocessorPackage.Literals.TABLE__ROW);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WordprocessorPackage.Literals.SECTION_CONTENTS__SUBTITLE,
				 WordprocessorFactory.eINSTANCE.createTitle()));

		newChildDescriptors.add
			(createChildParameter
				(WordprocessorPackage.Literals.TABLE__TITLE,
				 WordprocessorFactory.eINSTANCE.createTitle()));

		newChildDescriptors.add
			(createChildParameter
				(WordprocessorPackage.Literals.TABLE__HEADER,
				 WordprocessorFactory.eINSTANCE.createHeader()));

		newChildDescriptors.add
			(createChildParameter
				(WordprocessorPackage.Literals.TABLE__ROW,
				 WordprocessorFactory.eINSTANCE.createRow()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == WordprocessorPackage.Literals.SECTION_CONTENTS__SUBTITLE ||
			childFeature == WordprocessorPackage.Literals.TABLE__TITLE;
