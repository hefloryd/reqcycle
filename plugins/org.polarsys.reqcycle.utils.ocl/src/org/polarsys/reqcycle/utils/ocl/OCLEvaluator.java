...
/**
 * An OCL evaluator that can evaluate OCL operations and queries by passing it strings representing the OCL code.
 */
public interface OCLEvaluator {
	...
	/**
	 * Returns true if the OCL Environment is dirty : EOperations were defined in it with compilations errors. The operations should be re-compiled.
	 * 
	 * @return
	 */
	...
	/**
	 * Compiles an operation defined in ocl, in the OCL environment. The context on which the operation is applicable is computed from the metamodel prefix and the classifier name.
	 */
	...
	/**
	 * Finds an operation that was compiled in the OCL environment of this evaluator, and that is compatible with the given context.
	 */
