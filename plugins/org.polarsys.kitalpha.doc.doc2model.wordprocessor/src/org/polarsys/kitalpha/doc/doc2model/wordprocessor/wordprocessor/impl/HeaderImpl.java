 ...
 * <ul>
 *   <li>{@link org.polarsys.kitalpha.doc.doc2model.wordprocessor.wordprocessor.impl.HeaderImpl#getCell <em>Cell</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HeaderImpl extends MinimalEObjectImpl.Container implements Header {
	...
	protected EClass eStaticClass() {
		return WordprocessorPackage.Literals.HEADER;
	}
	...
	public EList<Cell> getCell() {
		if (cell == null) {
			cell = new EObjectContainmentEList<Cell>(Cell.class, this, WordprocessorPackage.HEADER__CELL);
		}
		return cell;
	}
