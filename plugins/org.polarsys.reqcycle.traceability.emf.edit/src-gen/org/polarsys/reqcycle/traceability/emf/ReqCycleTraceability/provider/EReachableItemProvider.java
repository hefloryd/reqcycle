...
/**
 * This is the item provider adapter for a {@link org.polarsys.reqcycle.traceability.emf.ReqCycleTraceability.EReachable} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class EReachableItemProvider extends ElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	...
	protected void addDownwardsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_EReachable_downwards_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_EReachable_downwards_feature", "_UI_EReachable_type"), ReqCycleTraceabilityPackage.Literals.EREACHABLE__DOWNWARDS, true, false, true, null, null, null));
	}
	...
	protected void addTypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_EReachable_types_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_EReachable_types_feature", "_UI_EReachable_type"), ReqCycleTraceabilityPackage.Literals.EREACHABLE__TYPES, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addUpwardsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_EReachable_upwards_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_EReachable_upwards_feature", "_UI_EReachable_type"), ReqCycleTraceabilityPackage.Literals.EREACHABLE__UPWARDS, true, false, true, null, null, null));
	}
