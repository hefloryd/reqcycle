 ...
 */
public class Doc2ModelTextStripper extends PDFStreamEngine
{

	private static final String thisClassName = Doc2ModelTextStripper.class.getSimpleName().toLowerCase();
		...
		for( int i = 0; i < charactersByArticle.size(); i++)
		{
			...
			while( textIter.hasNext() )
			{
				...
				if( lastPosition != null )
				{
					...
					{
						String str = writeLine(line,isRtlDominant,hasRtl,isRtlDominant);
						line.clear();

						lastLineStartPosition = handleLineSeparation(current, lastPosition, lastLineStartPosition, maxHeightForLine, str);
			...
			if (line.size() > 0)
			{
				writeLine(line,isRtlDominant,hasRtl,isRtlDominant);
	...
	protected PositionWrapper handleLineSeparation(PositionWrapper current,
			PositionWrapper lastPosition, PositionWrapper lastLineStartPosition, float maxHeightForLine, String str)
					throws IOException {
	...
	protected void isParagraphSeparation(PositionWrapper position,  
		...
		if(lastLineStartPosition == null || previousLine.replaceAll("\\s","").isEmpty()) {
			result = true;
		}else{
			...
			if(yGap > (getDropThreshold()*maxHeightForLine)){
				...
				Pattern currentPattern = matchPattern(str,getHeaderOrListItemPatterns());
	...
	/**
	 * a header of regular expressions that match commonly used
	 * header item formats, i.e. numbers, letters,
	...
	private List<Pattern> headerOrListPatterns = null;
		...
		for(TextPosition text : line){
			...
			if (text instanceof WordSeparator) {
				...
				if(stxt.getCharacter().replaceAll("\\s","").length()>0){
					if(_inStyle ){
						if(!stxt.hasSameStyle(_previousTextPosition)){
							...
							lineBuilder = new StringBuilder();
							writeStyleEnd();
							writeStyleStart(stxt.getFontColor(),stxt.getFontSizeInPt(),stxt.isBold());
	 ...
	 *
	 */
	public class StylizedTextPosition extends TextPosition{
		...
		public boolean hasSameStyle(StylizedTextPosition stext){
			if((stext.getFontSize() != _text.getFontSize()) ||
					(stext._fontColor.getRGB() != _fontColor.getRGB()) ||
					(stext.isBold() != this.isBold())){
				return false;
			}else{
				return true;
			}
		...
		public boolean isBold(){
			PDFontDescriptor descriptor = _text.getFont().getFontDescriptor();
			if(descriptor != null){
				return (_text.getFont().getFontDescriptor().getFontWeight()>400);
			}else{
				return false;
			}
		}
		...
		public boolean contains(TextPosition arg0) {
			...
			return _text.contains(arg0);
		}
		@Override
		public String getCharacter() {

			return _text.getCharacter();
		}
		@Override
		public int[] getCodePoints() {

			return _text.getCodePoints();
		}
		@Override
		public float getDir() {
		...
		public float getFontSize() {
			...
			return _text.getFontSize();
		}
		@Override
		public float getFontSizeInPt() {

			return _text.getFontSizeInPt();
		}
		@Override
		...
		public float getHeightDir() {
			...
			return _text.getHeightDir();
		}
		@Override
		public float[] getIndividualWidths() {

			return _text.getIndividualWidths();
		}
		@Override
		public Matrix getTextPos() {

			return _text.getTextPos();
		}
		@Override
		...
		public float getWidthDirAdj() {
			...
			return _text.getWidthDirAdj();
		}
		@Override
		public float getWidthOfSpace() {

			return _text.getWidthOfSpace();
		}
		@SuppressWarnings("deprecation")
		@Override
		public float getWordSpacing() {

			return _text.getWordSpacing();
		}
		@Override
		public float getX() {
		...
		public float getXDirAdj() {
			...
			return _text.getXDirAdj();
		}
		@Override
		public float getXScale() {

			return _text.getXScale();
		}
		@Override
		public float getY() {
		...
		public float getYDirAdj() {
			...
			return _text.getYDirAdj();
		}
		@Override
		public float getYScale() {

			return _text.getYScale();
		}
		@Override
		public boolean isDiacritic() {

			return _text.isDiacritic();
		}
		@Override
		public void mergeDiacritic(TextPosition arg0, TextNormalize arg1) {

			_text.mergeDiacritic(arg0, arg1);
		}
	}
